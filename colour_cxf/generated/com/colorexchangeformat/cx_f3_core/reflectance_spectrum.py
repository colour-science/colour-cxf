...
class ReflectanceSpectrum:
    """
    Color Value type used to represent the spectral data reflected from an
    illuminated object relative to the amount of light reflected from a reference
    white surface (Percent Reflectance).
